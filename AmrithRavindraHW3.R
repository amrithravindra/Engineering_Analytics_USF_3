...
str(hw3)
table(hw3$Vandal) #This tells us that there were 1815 recorded cases of vandalism
#######
library(tm)
...
adddoc #This tells us that our document term matrix contains 3882 documents and 6675 terms
...
######### The alternate code that I used is as follows ###########
